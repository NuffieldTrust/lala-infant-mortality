...
# Check CSV files are in project data folder
# NT chart style
#-------------------------------------------------------------------------------
...
#install.packages(c("pacman", "fs", "epitools", "plyr", "RColorBrewer", "lm.beta"
#                   , "lmtest", "ciTools", "MASS", "mctest", "relaimpo", "AER"
#                   , "DescTools", "MASS", "rsq", "sf"))

pacman::p_load("tidyverse", "tidylog", "janitor", "broom", "psych", "tidytext"
               , "ggforce", "cowplot", "writexl", "ggpubr")


# Folder structure --------------------------------------------------------

fs::dir_create("r")
fs::dir_create("r", "fonts")
fs::dir_create("data")
...
fs::dir_create("output", "simple_glm_regression")
fs::dir_create("output", "simple_glm_regression", "plots")
fs::dir_create("output", "multiple_glm_regression")
fs::dir_create("output", "multiple_glm_regression", "plots")
...
# Nuffield Trust fonts

sysfonts::font_add(family = "Circular", regular = "r/fonts/CircularStd-Book.ttf"
                   , bold = "r/fonts/CircularStd-Bold.ttf")
...
NT_style <- function(){
  ...
  theme_minimal() %+replace%
    ...
    theme(
      ...
      axis.text.x = element_text(colour = NT_colour("cool mid grey"), size = 8, family = "Circular", vjust = 0),
      axis.text.y = element_text(colour = NT_colour("cool mid grey"), size = 8, family = "Circular"),
      axis.title.x = element_text(margin = margin(t = 0.3, r = 0, b = 0, l = 0, unit ="cm"), colour = NT_colour("NT ink"), size = 8, family = "Circular", face = "bold"),
      axis.title.y = element_text(margin = margin(t = 0, r = 0.3, b = 0, l = 0, unit ="cm"), colour = NT_colour("NT ink"), size = 8, family = "Circular", face = "bold", angle = 90),
      legend.text = element_text(colour = NT_colour("NT ink"), size = 8, family = "Circular"),
      legend.title = element_blank(),
      plot.caption = element_text(margin = margin(t = 0.3, r = 0, b = 0, l = 0, unit ="cm"), colour = NT_colour("NT ink"), size = 8, family = "Circular", hjust = 1, vjust = 1),
      plot.title = element_text(margin = margin(t = 0, r = 0, b = 0.3, l = 0, unit ="cm"), colour = NT_colour("NT ink"), size = 10, family = "Circular", face = "bold", hjust = 0),
      #plot.title.position = "plot",
      strip.text = element_text(margin = margin(t = 0, r = 0, b = 0.3, l = 0, unit ="cm"), colour = NT_colour("NT ink"), size = 8, family = "Circular", face = "bold"),
